...
#include <vector>
#include <omp.h>
#include "choleskyHost_Opt0_1.hpp"
...
//********************************
CholeskyHost_Opt0_1::CholeskyHost_Opt0_1(){}
CholeskyHost_Opt0_1::~CholeskyHost_Opt0_1(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool CholeskyHost_Opt0_1::exec(Execution exec, vector<double>& results, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"CholeskyHost::choleskyHost_Opt0_1_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool CholeskyHost_Opt0_1::initParameter(Execution exec, unsigned int &SIZE_N){
...
bool CholeskyHost_Opt0_1::compareResults(CholeskyKernel& data){
...
void CholeskyHost_Opt0_1::emsamble_dataToBuffers(CholeskyKernel& data, vector<typeData> &temp_A, vector<typeData>& temp_resultDevice){
...
void CholeskyHost_Opt0_1::emsamble_buffersToData(CholeskyKernel& data, vector<typeData>& temp_resultDevice){
