...
void CholeskyHost_Opt2::emsamble_dataToBuffers(CholeskyKernel& data, vector<typeData> &temp_A, vector<typeData>& temp_resultDevice){
...
void CholeskyHost_Opt2::emsamble_buffersToData(CholeskyKernel& data, vector<typeData>& temp_resultDevice){
