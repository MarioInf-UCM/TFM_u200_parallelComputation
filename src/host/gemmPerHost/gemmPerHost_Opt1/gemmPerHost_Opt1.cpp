...
atomic<bool> GemmPerHost_Opt1::stop_thread(false);
double GemmPerHost_Opt1::sharedVariable=0.0f;
...
GemmPerHost_Opt1::GemmPerHost_Opt1(){}
GemmPerHost_Opt1::~GemmPerHost_Opt1(){}
//*************************************
// MAIN FUNCTION - START
//*************************************
bool GemmPerHost_Opt1::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"GemmPerHost::gemmPerHost_Opt1_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool GemmPerHost_Opt1::initParameter(Execution exec, unsigned int &SIZE_I, unsigned int &SIZE_J, unsigned int &SIZE_K){
...
void GemmPerHost_Opt1::emsamble_dataToBuffers(GemmPerKernel& data, vector<typeData> &temp_A, vector<typeData>& temp_B, vector<typeData>& temp_C, vector<typeData>& temp_resultDevice){
...
void GemmPerHost_Opt1::emsamble_buffersToData(GemmPerKernel& data, vector<typeData>& temp_resultDevice){
...
bool GemmPerHost_Opt1::compareResults(GemmPerKernel& data){
    typeData tolerance = 0.1;
    typeData tempDataCPU, tempDataDevice;
...
float GemmPerHost_Opt1::searchPropertyValue(const string& texto, const string& subcadena) {
...
double GemmPerHost_Opt1::executeAndMeasure_CPU(GemmPerKernel& data, EventTimer &event){
...
double GemmPerHost_Opt1::executeAndMeasure_CPUopt(GemmPerKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void GemmPerHost_Opt1::threadFunction_DevicePowerMeasure() {
