...
extern "C"{
    ...
    //*************************************
    #ifdef MINI_DATASET
        void ker_jacobi2d_Opt3_mini(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #elif defined(SMALL_DATASET)
        void ker_jacobi2d_Opt3_small(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #elif defined(MEDIUM_DATASET)
        void ker_jacobi2d_Opt3_medium(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #elif defined(LARGE_DATASET)
        void ker_jacobi2d_Opt3_large(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #elif defined(EXTRALARGE_DATASET)
        void ker_jacobi2d_Opt3_extralarge(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #else
        void ker_jacobi2d_Opt3(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #endif
    {
