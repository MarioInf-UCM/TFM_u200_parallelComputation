...
atomic<bool> StudyCase3Host_b::stop_thread(false);
double StudyCase3Host_b::sharedVariable=0.0f;

//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
StudyCase3Host_b::StudyCase3Host_b(){}
StudyCase3Host_b::~StudyCase3Host_b(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool StudyCase3Host_b::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"VectorAddHost::StudyCase3Host_b_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
    ...
    if(exec.get_measurePower_CPUopt()){
        ...
        data.kernel_studyCase3_b_CPU_opt();
    }
...
// MAIN FUNCTION - END
//*************************************
bool StudyCase3Host_b::initParameter(Execution exec, unsigned int &SIZE){
...
bool StudyCase3Host_b::compareResults(StudyCase3Kernel& data){
...
void StudyCase3Host_b::ensamble_dataToBuffers(StudyCase3Kernel& data, typeData_fixed *temp_A, typeData_fixed *temp_B, typeData_fixed *temp_resultDevice){
...
void StudyCase3Host_b::ensamble_buffersToData(StudyCase3Kernel& data, typeData_fixed *temp_resultDevice){
...
double StudyCase3Host_b::executeAndMeasure_CPU(StudyCase3Kernel& data, EventTimer &event){
    ...
    CPU_ZERO(&cpuset);
    CPU_SET(core, &cpuset);
    function<void()> func = [&data]() { data.kernel_studyCase3_b_CPU(); };
...
double StudyCase3Host_b::executeAndMeasure_CPUopt(StudyCase3Kernel& data, vector<double> &measureByPack, EventTimer &event){
...
void StudyCase3Host_b::threadFunction_DevicePowerMeasure() {
...
float StudyCase3Host_b::searchPropertyValue(const string& texto, const string& subcadena) {
