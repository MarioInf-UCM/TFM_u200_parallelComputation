...
atomic<bool> GemmHost_Opt3::stop_thread(false);
double GemmHost_Opt3::sharedVariable=0.0f;
...
GemmHost_Opt3::GemmHost_Opt3(){}
GemmHost_Opt3::~GemmHost_Opt3(){}
//*************************************
// MAIN FUNCTION - START
//*************************************
bool GemmHost_Opt3::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"GemmHost::gemmHost_Opt3_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool GemmHost_Opt3::initParameter(Execution exec, unsigned int &SIZE_I, unsigned int &SIZE_J, unsigned int &SIZE_K){
...
void GemmHost_Opt3::emsamble_dataToBuffers(GemmKernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_C,typeData *temp_resultDevice){
...
void GemmHost_Opt3::emsamble_buffersToData(GemmKernel& data, typeData *temp_resultDevice){
...
bool GemmHost_Opt3::compareResults(GemmKernel& data){
...
float GemmHost_Opt3::searchPropertyValue(const string& texto, const string& subcadena) {
...
double GemmHost_Opt3::executeAndMeasure_CPU(GemmKernel& data, EventTimer &event){
...
double GemmHost_Opt3::executeAndMeasure_CPUopt(GemmKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void GemmHost_Opt3::threadFunction_DevicePowerMeasure() {
