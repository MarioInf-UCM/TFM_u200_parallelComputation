...
atomic<bool> StudyCase2Host_d::stop_thread(false);
double StudyCase2Host_d::sharedVariable=0.0f;


//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
StudyCase2Host_d::StudyCase2Host_d(){}
StudyCase2Host_d::~StudyCase2Host_d(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool StudyCase2Host_d::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"VectorAddHost::StudyCase2Host_d_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
    ...
    if(exec.get_measurePower_CPUopt()){
        ...
        data.kernel_studyCase2_d_CPU_opt();
    }
...
// MAIN FUNCTION - END
//*************************************
bool StudyCase2Host_d::initParameter(Execution exec, unsigned int &SIZE){
...
bool StudyCase2Host_d::compareResults(StudyCase2Kernel& data){
...
void StudyCase2Host_d::ensamble_dataToBuffers(StudyCase2Kernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_resultDevice){
...
void StudyCase2Host_d::ensamble_buffersToData(StudyCase2Kernel& data, typeData *temp_resultDevice){
...
float StudyCase2Host_d::searchPropertyValue(const string& texto, const string& subcadena) {
...
double StudyCase2Host_d::executeAndMeasure_CPU(StudyCase2Kernel& data, EventTimer &event){
    ...
    CPU_ZERO(&cpuset);
    CPU_SET(core, &cpuset);
    function<void()> func = [&data]() { data.kernel_studyCase2_d_CPU(); };
...
double StudyCase2Host_d::executeAndMeasure_CPUopt(StudyCase2Kernel& data, vector<double> &measureByPack, EventTimer &event){
...
void StudyCase2Host_d::threadFunction_DevicePowerMeasure() {
