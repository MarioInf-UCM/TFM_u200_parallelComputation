...
atomic<bool> CholeskyHost_Opt4::stop_thread(false);
double CholeskyHost_Opt4::sharedVariable=0.0f;
...
//********************************
CholeskyHost_Opt4::CholeskyHost_Opt4(){}
CholeskyHost_Opt4::~CholeskyHost_Opt4(){}
...
// MAIN FUNCTION - START
//*************************************
bool CholeskyHost_Opt4::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"CholeskyHost::choleskyHost_Opt3_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool CholeskyHost_Opt4::initParameter(Execution exec, unsigned int &SIZE_N){
...
bool CholeskyHost_Opt4::compareResults(CholeskyKernel& data){
...
void CholeskyHost_Opt4::emsamble_dataToBuffers(CholeskyKernel& data, typeData_fixed *temp_A, typeData_fixed *temp_resultDevice){
    int i=0;
    for (int n1 = 0; n1 < data.get_SIZE_N(); n1++) {
        for (int n2 = 0; n2 < data.get_SIZE_N(); n2++) {
            temp_A[i] = data.get_A()[n1][n2];
...
void CholeskyHost_Opt4::emsamble_buffersToData(CholeskyKernel& data, typeData_fixed *temp_resultDevice){
...
float CholeskyHost_Opt4::searchPropertyValue(const string& texto, const string& subcadena) {
...
double CholeskyHost_Opt4::executeAndMeasure_CPU(CholeskyKernel& data, EventTimer &event){
...
double CholeskyHost_Opt4::executeAndMeasure_CPUopt(CholeskyKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void CholeskyHost_Opt4::threadFunction_DevicePowerMeasure() {
