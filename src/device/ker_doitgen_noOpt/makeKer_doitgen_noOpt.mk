...
ker_doitgen_noOpt_mini_CUSTOMPARAMS := -DMINI_DATASET
ker_doitgen_noOpt_small_CUSTOMPARAMS := -DSMALL_DATASET
ker_doitgen_noOpt_medium_CUSTOMPARAMS := -DMEDIUM_DATASET
ker_doitgen_noOpt_large_CUSTOMPARAMS := -DLARGE_DATASET
ker_doitgen_noOpt_extralarge_CUSTOMPARAMS := -DEXTRALARGE_DATASET


ker_doitgen_noOpt_FOLDER := ./
ker_doitgen_noOpt_SRC := ker_doitgen_noOpt.cpp
ker_doitgen_noOpt_SRC_ROUTE := $(ker_doitgen_noOpt_FOLDER)ker_doitgen_noOpt.cpp
ker_doitgen_noOpt_HEADER :=
ker_doitgen_noOpt_HEADER_ROUTE :=
...
copy_files:
	...
	cp ${ker_doitgen_noOpt_SRC_ROUTE} ${BUILD_DIR}/${KERNEL_BUILD_SUBFOLDER};
...
kerPack_doitgen_noOpt_sw_emu.xclbin: $(ker_doitgen_noOpt_XOS) $(BOARD_CONFIG)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_doitgen_noOpt_XOS) --remote_ip_cache ${IP_CACHE_DIR}
...
ker_doitgen_noOpt_mini.xo: $(ker_doitgen_noOpt_SRC) $(ker_doitgen_noOpt_HEADER)
	v++ --kernel $(ker_doitgen_noOpt_mini_KERNEL) $(VPPFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_doitgen_noOpt_mini_CUSTOMPARAMS) -c -o $@ $(ker_doitgen_noOpt_SRC) $<

ker_doitgen_noOpt_small.xo: $(ker_doitgen_noOpt_SRC) $(ker_doitgen_noOpt_HEADER)
	v++ --kernel $(ker_doitgen_noOpt_small_KERNEL) $(VPPFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_doitgen_noOpt_small_CUSTOMPARAMS) -c -o $@ $(ker_doitgen_noOpt_SRC) $<

ker_doitgen_noOpt_medium.xo: $(ker_doitgen_noOpt_SRC) $(ker_doitgen_noOpt_HEADER)
	v++ --kernel $(ker_doitgen_noOpt_medium_KERNEL) $(VPPFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_doitgen_noOpt_medium_CUSTOMPARAMS) -c -o $@ $(ker_doitgen_noOpt_SRC) $<

ker_doitgen_noOpt_large.xo: $(ker_doitgen_noOpt_SRC) $(ker_doitgen_noOpt_HEADER)
	v++ --kernel $(ker_doitgen_noOpt_large_KERNEL) $(VPPFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_doitgen_noOpt_large_CUSTOMPARAMS) -c -o $@ $(ker_doitgen_noOpt_SRC) $<

ker_doitgen_noOpt_extralarge.xo: $(ker_doitgen_noOpt_SRC) $(ker_doitgen_noOpt_HEADER)
	v++ --kernel $(ker_doitgen_noOpt_extralarge_KERNEL) $(VPPFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_doitgen_noOpt_extralarge_CUSTOMPARAMS) -c -o $@ $(ker_doitgen_noOpt_SRC) $<