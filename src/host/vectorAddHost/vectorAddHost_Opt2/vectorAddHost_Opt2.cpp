...
#include "vectorAddHost_Opt2.hpp"
...
atomic<bool> VectorAddHost_Opt2::stop_thread(false);
double VectorAddHost_Opt2::sharedVariable=0.0f;


//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
VectorAddHost_Opt2::VectorAddHost_Opt2(){}
VectorAddHost_Opt2::~VectorAddHost_Opt2(){}
...
// MAIN FUNCTION - END
//*************************************
bool VectorAddHost_Opt2::initParameter(Execution exec, unsigned int &SIZE){
...
bool VectorAddHost_Opt2::compareResults(VectorAddKernel& data){
...
void VectorAddHost_Opt2::ensamble_dataToBuffers(VectorAddKernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_resultDevice){
...
void VectorAddHost_Opt2::ensamble_buffersToData(VectorAddKernel& data, typeData *temp_resultDevice){
...
float VectorAddHost_Opt2::searchPropertyValue(const string& texto, const string& subcadena) {
...
double VectorAddHost_Opt2::executeAndMeasure_CPU(VectorAddKernel& data, EventTimer &event){
...
double VectorAddHost_Opt2::executeAndMeasure_CPUopt(VectorAddKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void VectorAddHost_Opt2::threadFunction_DevicePowerMeasure() {
