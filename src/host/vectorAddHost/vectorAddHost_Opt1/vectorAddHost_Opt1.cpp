...
#include "vectorAddHost_Opt1.hpp"
...
atomic<bool> VectorAddHost_Opt1::stop_thread(false);
double VectorAddHost_Opt1::sharedVariable=0.0f;


//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
VectorAddHost_Opt1::VectorAddHost_Opt1(){}
VectorAddHost_Opt1::~VectorAddHost_Opt1(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool VectorAddHost_Opt1::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"VectorAddHost::VectorAddHost_Opt1_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
// MAIN FUNCTION - END
//*************************************
bool VectorAddHost_Opt1::initParameter(Execution exec, unsigned int &SIZE){
...
bool VectorAddHost_Opt1::compareResults(VectorAddKernel& data){
...
void VectorAddHost_Opt1::ensamble_dataToBuffers(VectorAddKernel& data, vector<typeData> &temp_A, vector<typeData> &temp_B, vector<typeData>& temp_resultDevice){
...
void VectorAddHost_Opt1::ensamble_buffersToData(VectorAddKernel& data, vector<typeData>& temp_resultDevice){
...
float VectorAddHost_Opt1::searchPropertyValue(const string& texto, const string& subcadena) {
...
double VectorAddHost_Opt1::executeAndMeasure_CPU(VectorAddKernel& data, EventTimer &event){
...
double VectorAddHost_Opt1::executeAndMeasure_CPUopt(VectorAddKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void VectorAddHost_Opt1::threadFunction_DevicePowerMeasure() {
