...
kerPack_jacobi2d_Opt0_mini_sw_emu.xclbin: $(ker_jacobi2d_Opt0_mini_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_mini_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_small_sw_emu.xclbin: $(ker_jacobi2d_Opt0_small_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_small_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_medium_sw_emu.xclbin: $(ker_jacobi2d_Opt0_medium_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_medium_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_large_sw_emu.xclbin: $(ker_jacobi2d_Opt0_large_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_large_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_extralarge_sw_emu.xclbin: $(ker_jacobi2d_Opt0_extralarge_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_extralarge_XOS) --remote_ip_cache ${IP_CACHE_DIR}



kerPack_jacobi2d_Opt0_mini_hw_emu.xclbin: $(ker_jacobi2d_Opt0_mini_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_mini_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_small_hw_emu.xclbin: $(ker_jacobi2d_Opt0_small_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_small_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_medium_hw_emu.xclbin: $(ker_jacobi2d_Opt0_medium_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_medium_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_large_hw_emu.xclbin: $(ker_jacobi2d_Opt0_large_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_large_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_extralarge_hw_emu.xclbin: $(ker_jacobi2d_Opt0_extralarge_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_extralarge_XOS) --remote_ip_cache ${IP_CACHE_DIR}



kerPack_jacobi2d_Opt0_mini_hw.xclbin: $(ker_jacobi2d_Opt0_mini_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_mini_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_small_hw.xclbin: $(ker_jacobi2d_Opt0_small_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_small_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_medium_hw.xclbin: $(ker_jacobi2d_Opt0_medium_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_medium_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_large_hw.xclbin: $(ker_jacobi2d_Opt0_large_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_large_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_jacobi2d_Opt0_extralarge_hw.xclbin: $(ker_jacobi2d_Opt0_extralarge_XOS) $(CONNECTIVITY_NAME)
	v++ -l $(VPPFLAGS) $(VPPLFLAGS) -o $@ $(ker_jacobi2d_Opt0_extralarge_XOS) --remote_ip_cache ${IP_CACHE_DIR}
...
ker_jacobi2d_Opt0_mini.xo: $(ker_jacobi2d_Opt0_SRC) $(ker_jacobi2d_Opt0_HEADER)
	v++ --kernel $(ker_jacobi2d_Opt0_mini_KERNEL) $(VPPFLAGS) $(VPPLFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_jacobi2d_Opt0_mini_CUSTOMPARAMS) -c -o $@ $(ker_jacobi2d_Opt0_SRC) $<

ker_jacobi2d_Opt0_small.xo: $(ker_jacobi2d_Opt0_SRC) $(ker_jacobi2d_Opt0_HEADER)
	v++ --kernel $(ker_jacobi2d_Opt0_small_KERNEL) $(VPPFLAGS) $(VPPLFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_jacobi2d_Opt0_small_CUSTOMPARAMS) -c -o $@ $(ker_jacobi2d_Opt0_SRC) $<

ker_jacobi2d_Opt0_medium.xo: $(ker_jacobi2d_Opt0_SRC) $(ker_jacobi2d_Opt0_HEADER)
	v++ --kernel $(ker_jacobi2d_Opt0_medium_KERNEL) $(VPPFLAGS) $(VPPLFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_jacobi2d_Opt0_medium_CUSTOMPARAMS) -c -o $@ $(ker_jacobi2d_Opt0_SRC) $<

ker_jacobi2d_Opt0_large.xo: $(ker_jacobi2d_Opt0_SRC) $(ker_jacobi2d_Opt0_HEADER)
	v++ --kernel $(ker_jacobi2d_Opt0_large_KERNEL) $(VPPFLAGS) $(VPPLFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_jacobi2d_Opt0_large_CUSTOMPARAMS) -c -o $@ $(ker_jacobi2d_Opt0_SRC) $<

ker_jacobi2d_Opt0_extralarge.xo: $(ker_jacobi2d_Opt0_SRC) $(ker_jacobi2d_Opt0_HEADER)
	v++ --kernel $(ker_jacobi2d_Opt0_extralarge_KERNEL) $(VPPFLAGS) $(VPPLFLAGS) $(CUSTOMPARAMS_GENERAL) $(ker_jacobi2d_Opt0_extralarge_CUSTOMPARAMS) -c -o $@ $(ker_jacobi2d_Opt0_SRC) $<