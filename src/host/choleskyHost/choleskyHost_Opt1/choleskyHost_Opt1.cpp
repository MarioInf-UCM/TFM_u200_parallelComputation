...
// MAIN FUNCTION - START
//*************************************
bool CholeskyHost_Opt1::exec(Execution exec, vector<double>& results, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
void CholeskyHost_Opt1::emsamble_dataToBuffers(CholeskyKernel& data, typeData *temp_A, typeData *temp_resultDevice){
...
void CholeskyHost_Opt1::emsamble_buffersToData(CholeskyKernel& data, typeData *temp_resultDevice){
