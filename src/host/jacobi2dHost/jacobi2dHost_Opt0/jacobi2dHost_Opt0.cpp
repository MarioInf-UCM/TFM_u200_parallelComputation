...
atomic<bool> Jacobi2dHost_Opt0::stop_thread(false);
double Jacobi2dHost_Opt0::sharedVariable=0.0f;

//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
Jacobi2dHost_Opt0::Jacobi2dHost_Opt0(){}
Jacobi2dHost_Opt0::~Jacobi2dHost_Opt0(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool Jacobi2dHost_Opt0::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"Jacobi2dHost::Jacobi2dHost_Opt0_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool Jacobi2dHost_Opt0::initParameter(Execution exec, unsigned int &STEPS, unsigned int &SIZE_N){
...
bool Jacobi2dHost_Opt0::compareResults(Jacobi_2dKernel& data){
...
float Jacobi2dHost_Opt0::searchPropertyValue(const string& texto, const string& subcadena) {
...
double Jacobi2dHost_Opt0::executeAndMeasure_CPU(Jacobi_2dKernel& data, EventTimer &event){
...
double Jacobi2dHost_Opt0::executeAndMeasure_CPUopt(Jacobi_2dKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void Jacobi2dHost_Opt0::threadFunction_DevicePowerMeasure() {
