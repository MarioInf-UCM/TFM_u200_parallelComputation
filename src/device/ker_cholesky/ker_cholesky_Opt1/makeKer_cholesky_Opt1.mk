...
#**********************
ifeq ($(TARGET),sw_emu)
	KERNEL_BUILD_SUBFOLDER := ker_cholesky_Opt1/sw_emu/
else ifeq ($(TARGET),hw_emu)
	KERNEL_BUILD_SUBFOLDER := ker_cholesky_Opt1/hw_emu/
else ifeq ($(TARGET),hw)
...
#********************************************
#* COMPILATION OF kercholesky_Opt1imization *
#********************************************
MAKEFILE_NAME := makeKer_cholesky_Opt1.mk

PackKerList := kerPack_cholesky_Opt1_mini
PackKerList += kerPack_cholesky_Opt1_small
PackKerList += kerPack_cholesky_Opt1_medium
PackKerList += kerPack_cholesky_Opt1_large
PackKerList += kerPack_cholesky_Opt1_extralarge


ker_cholesky_Opt1_mini_XOS := ker_cholesky_Opt1_mini.xo
ker_cholesky_Opt1_small_XOS := ker_cholesky_Opt1_small.xo
ker_cholesky_Opt1_medium_XOS := ker_cholesky_Opt1_medium.xo
ker_cholesky_Opt1_large_XOS := ker_cholesky_Opt1_large.xo
ker_cholesky_Opt1_extralarge_XOS := ker_cholesky_Opt1_extralarge.xo

ker_cholesky_Opt1_mini_KERNEL := ker_cholesky_Opt1_mini
ker_cholesky_Opt1_small_KERNEL := ker_cholesky_Opt1_small
ker_cholesky_Opt1_medium_KERNEL := ker_cholesky_Opt1_medium
ker_cholesky_Opt1_large_KERNEL := ker_cholesky_Opt1_large
ker_cholesky_Opt1_extralarge_KERNEL := ker_cholesky_Opt1_extralarge


ker_cholesky_Opt1_mini_CUSTOMPARAMS := -DMINI_DATASET
ker_cholesky_Opt1_small_CUSTOMPARAMS := -DSMALL_DATASET
ker_cholesky_Opt1_medium_CUSTOMPARAMS := -DMEDIUM_DATASET
ker_cholesky_Opt1_large_CUSTOMPARAMS := -DLARGE_DATASET
ker_cholesky_Opt1_extralarge_CUSTOMPARAMS := -DEXTRALARGE_DATASET


ker_cholesky_Opt1_SRC := ker_cholesky_Opt1.cpp
ker_cholesky_Opt1_HEADER :=
