...
atomic<bool> GemmHost_Opt2::stop_thread(false);
double GemmHost_Opt2::sharedVariable=0.0f;
...
GemmHost_Opt2::GemmHost_Opt2(){}
GemmHost_Opt2::~GemmHost_Opt2(){}
//*************************************
// MAIN FUNCTION - START
//*************************************
bool GemmHost_Opt2::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
bool GemmHost_Opt2::initParameter(Execution exec, unsigned int &SIZE_I, unsigned int &SIZE_J, unsigned int &SIZE_K){
...
void GemmHost_Opt2::emsamble_dataToBuffers(GemmKernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_C,typeData *temp_resultDevice){
...
void GemmHost_Opt2::emsamble_buffersToData(GemmKernel& data, typeData *temp_resultDevice){
...
bool GemmHost_Opt2::compareResults(GemmKernel& data){
...
float GemmHost_Opt2::searchPropertyValue(const string& texto, const string& subcadena) {
...
double GemmHost_Opt2::executeAndMeasure_CPU(GemmKernel& data, EventTimer &event){
...
double GemmHost_Opt2::executeAndMeasure_CPUopt(GemmKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void GemmHost_Opt2::threadFunction_DevicePowerMeasure() {
