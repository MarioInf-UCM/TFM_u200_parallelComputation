...
bool CholeskyHost_noOpt::choleskyHost_noOpt_exec(Execution exec, vector<double>& results, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"CholeskyHost::choleskyHost_noOpt_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool CholeskyHost_noOpt::compareResults(CholeskyKernel& data){
...
void CholeskyHost_noOpt::emsamble_dataToBuffers(CholeskyKernel& data, vector<typeData> &temp_A, vector<typeData>& temp_resultDevice){
...
void CholeskyHost_noOpt::emsamble_buffersToData(CholeskyKernel& data, vector<typeData>& temp_resultDevice){
