...
atomic<bool> GemmHost_Opt0::stop_thread(false);
double GemmHost_Opt0::sharedVariable=0.0f;
...
// MAIN FUNCTION - START
//*************************************
bool GemmHost_Opt0::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
float GemmHost_Opt0::searchPropertyValue(const string& texto, const string& subcadena) {
...
double GemmHost_Opt0::executeAndMeasure_CPU(GemmKernel& data, EventTimer &event){
...
double GemmHost_Opt0::executeAndMeasure_CPUopt(GemmKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void GemmHost_Opt0::threadFunction_DevicePowerMeasure() {
