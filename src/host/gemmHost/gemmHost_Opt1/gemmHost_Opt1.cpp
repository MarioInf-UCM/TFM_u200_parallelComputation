...
atomic<bool> GemmHost_Opt1::stop_thread(false);
double GemmHost_Opt1::sharedVariable=0.0f;
...
// MAIN FUNCTION - START
//*************************************
bool GemmHost_Opt1::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
void GemmHost_Opt1::emsamble_dataToBuffers(GemmKernel& data, vector<typeData> &temp_A, vector<typeData>& temp_B, vector<typeData>& temp_C, vector<typeData>& temp_resultDevice){
...
void GemmHost_Opt1::emsamble_buffersToData(GemmKernel& data, vector<typeData>& temp_resultDevice){
...
float GemmHost_Opt1::searchPropertyValue(const string& texto, const string& subcadena) {
...
double GemmHost_Opt1::executeAndMeasure_CPU(GemmKernel& data, EventTimer &event){
...
double GemmHost_Opt1::executeAndMeasure_CPUopt(GemmKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void GemmHost_Opt1::threadFunction_DevicePowerMeasure() {
