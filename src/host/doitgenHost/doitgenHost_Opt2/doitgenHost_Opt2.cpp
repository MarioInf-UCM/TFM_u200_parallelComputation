...
atomic<bool> DoitgenHost_Opt2::stop_thread(false);
double DoitgenHost_Opt2::sharedVariable=0.0f;
...
// MAIN FUNCTION - START
//*************************************
bool DoitgenHost_Opt2::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
void DoitgenHost_Opt2::emsamble_dataToBuffers(DoitgenKernel& data, typeData *temp_A,  typeData *temp_C4, typeData *temp_resultDevice){
...
void DoitgenHost_Opt2::emsamble_buffersToData(DoitgenKernel& data, typeData *temp_resultDevice){
...
float DoitgenHost_Opt2::searchPropertyValue(const string& texto, const string& subcadena) {
...
double DoitgenHost_Opt2::executeAndMeasure_CPU(DoitgenKernel& data, EventTimer &event){
...
double DoitgenHost_Opt2::executeAndMeasure_CPUopt(DoitgenKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void DoitgenHost_Opt2::threadFunction_DevicePowerMeasure() {
