...
void GemmHost_Opt2::emsamble_dataToBuffers(GemmKernel& data, vector<typeData> &temp_A, vector<typeData>& temp_B, vector<typeData>& temp_C, vector<typeData>& temp_resultDevice){
...
void GemmHost_Opt2::emsamble_buffersToData(GemmKernel& data, vector<typeData>& temp_resultDevice){
