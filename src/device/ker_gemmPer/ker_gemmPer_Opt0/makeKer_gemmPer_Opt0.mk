...
kerPack_gemmPer_Opt0_mini_sw_emu.xclbin: $(ker_gemmPer_Opt0_mini_XOS) $(CONNECTIVITY_NAME_MINI)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_MINI) -o $@ $(ker_gemmPer_Opt0_mini_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_small_sw_emu.xclbin: $(ker_gemmPer_Opt0_small_XOS) $(CONNECTIVITY_NAME_SMALL)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_SMALL) -o $@ $(ker_gemmPer_Opt0_small_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_medium_sw_emu.xclbin: $(ker_gemmPer_Opt0_medium_XOS) $(CONNECTIVITY_NAME_MEDIUM)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_MEDIUM) -o $@ $(ker_gemmPer_Opt0_medium_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_large_sw_emu.xclbin: $(ker_gemmPer_Opt0_large_XOS) $(CONNECTIVITY_NAME_LARGE)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_LARGE) -o $@ $(ker_gemmPer_Opt0_large_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_extralarge_sw_emu.xclbin: $(ker_gemmPer_Opt0_extralarge_XOS) $(CONNECTIVITY_NAME_EXTRALARGE)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_EXTRALARGE) -o $@ $(ker_gemmPer_Opt0_extralarge_XOS) --remote_ip_cache ${IP_CACHE_DIR}



kerPack_gemmPer_Opt0_mini_hw_emu.xclbin: $(ker_gemmPer_Opt0_mini_XOS) $(CONNECTIVITY_NAME_MINI)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_MINI) -o $@ $(ker_gemmPer_Opt0_mini_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_small_hw_emu.xclbin: $(ker_gemmPer_Opt0_small_XOS) $(CONNECTIVITY_NAME_SMALL)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_SMALL) -o $@ $(ker_gemmPer_Opt0_small_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_medium_hw_emu.xclbin: $(ker_gemmPer_Opt0_medium_XOS) $(CONNECTIVITY_NAME_MEDIUM)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_MEDIUM) -o $@ $(ker_gemmPer_Opt0_medium_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_large_hw_emu.xclbin: $(ker_gemmPer_Opt0_large_XOS) $(CONNECTIVITY_NAME_LARGE)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_LARGE) -o $@ $(ker_gemmPer_Opt0_large_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_extralarge_hw_emu.xclbin: $(ker_gemmPer_Opt0_extralarge_XOS) $(CONNECTIVITY_NAME_EXTRALARGE)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_EXTRALARGE) -o $@ $(ker_gemmPer_Opt0_extralarge_XOS) --remote_ip_cache ${IP_CACHE_DIR}



kerPack_gemmPer_Opt0_mini_hw.xclbin: $(ker_gemmPer_Opt0_mini_XOS) $(CONNECTIVITY_NAME_MINI)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_MINI) -o $@ $(ker_gemmPer_Opt0_mini_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_small_hw.xclbin: $(ker_gemmPer_Opt0_small_XOS) $(CONNECTIVITY_NAME_SMALL)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_SMALL) -o $@ $(ker_gemmPer_Opt0_small_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_medium_hw.xclbin: $(ker_gemmPer_Opt0_medium_XOS) $(CONNECTIVITY_NAME_MEDIUM)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_MEDIUM) -o $@ $(ker_gemmPer_Opt0_medium_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_large_hw.xclbin: $(ker_gemmPer_Opt0_large_XOS) $(CONNECTIVITY_NAME_LARGE)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_LARGE) -o $@ $(ker_gemmPer_Opt0_large_XOS) --remote_ip_cache ${IP_CACHE_DIR}

kerPack_gemmPer_Opt0_extralarge_hw.xclbin: $(ker_gemmPer_Opt0_extralarge_XOS) $(CONNECTIVITY_NAME_EXTRALARGE)
	v++ -l $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_EXTRALARGE) -o $@ $(ker_gemmPer_Opt0_extralarge_XOS) --remote_ip_cache ${IP_CACHE_DIR}
...
ker_gemmPer_Opt0_mini.xo: $(ker_gemmPer_Opt0_SRC) $(ker_gemmPer_Opt0_HEADER)
	v++ --kernel $(ker_gemmPer_Opt0_mini_KERNEL) $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_MINI) $(ker_gemmPer_Opt0_mini_CUSTOMPARAMS) -c -o $@ $(ker_gemmPer_Opt0_SRC) $<

ker_gemmPer_Opt0_small.xo: $(ker_gemmPer_Opt0_SRC) $(ker_gemmPer_Opt0_HEADER)
	v++ --kernel $(ker_gemmPer_Opt0_small_KERNEL) $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_SMALL) $(ker_gemmPer_Opt0_small_CUSTOMPARAMS) -c -o $@ $(ker_gemmPer_Opt0_SRC) $<

ker_gemmPer_Opt0_medium.xo: $(ker_gemmPer_Opt0_SRC) $(ker_gemmPer_Opt0_HEADER)
	v++ --kernel $(ker_gemmPer_Opt0_medium_KERNEL) $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_MEDIUM) $(ker_gemmPer_Opt0_medium_CUSTOMPARAMS) -c -o $@ $(ker_gemmPer_Opt0_SRC) $<

ker_gemmPer_Opt0_large.xo: $(ker_gemmPer_Opt0_SRC) $(ker_gemmPer_Opt0_HEADER)
	v++ --kernel $(ker_gemmPer_Opt0_large_KERNEL) $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_LARGE) $(ker_gemmPer_Opt0_large_CUSTOMPARAMS) -c -o $@ $(ker_gemmPer_Opt0_SRC) $<

ker_gemmPer_Opt0_extralarge.xo: $(ker_gemmPer_Opt0_SRC) $(ker_gemmPer_Opt0_HEADER)
	v++ --kernel $(ker_gemmPer_Opt0_extralarge_KERNEL) $(VPPFLAGS_GENERAL) $(VPPLFLAGS_SPECIFIC_EXTRALARGE) $(ker_gemmPer_Opt0_extralarge_CUSTOMPARAMS) -c -o $@ $(ker_gemmPer_Opt0_SRC) $<