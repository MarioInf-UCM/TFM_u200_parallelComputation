...
bool StudyCase2Host_c::compareResults(VectorAddKernel& data){
...
void StudyCase2Host_c::ensamble_dataToBuffers(VectorAddKernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_resultDevice){
...
void StudyCase2Host_c::ensamble_buffersToData(VectorAddKernel& data, typeData *temp_resultDevice){
...
double StudyCase2Host_c::executeAndMeasure_CPU(VectorAddKernel& data, EventTimer &event){
...
double StudyCase2Host_c::executeAndMeasure_CPUopt(VectorAddKernel& data, vector<double> &measureByPack, EventTimer &event){
