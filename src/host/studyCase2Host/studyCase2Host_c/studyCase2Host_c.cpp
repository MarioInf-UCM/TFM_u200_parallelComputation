...
atomic<bool> StudyCase2Host_c::stop_thread(false);
double StudyCase2Host_c::sharedVariable=0.0f;


//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
StudyCase2Host_c::StudyCase2Host_c(){}
StudyCase2Host_c::~StudyCase2Host_c(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool StudyCase2Host_c::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"VectorAddHost::StudyCase2Host_c_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
    ...
    if(exec.get_measurePower_CPUopt()){
        ...
        data.kernel_studyCase2_c_CPU_opt();
    }
...
// MAIN FUNCTION - END
//*************************************
bool StudyCase2Host_c::initParameter(Execution exec, unsigned int &SIZE){
...
bool StudyCase2Host_c::compareResults(StudyCase2Kernel& data){
...
void StudyCase2Host_c::ensamble_dataToBuffers(StudyCase2Kernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_resultDevice){
...
void StudyCase2Host_c::ensamble_buffersToData(StudyCase2Kernel& data, typeData *temp_resultDevice){
...
float StudyCase2Host_c::searchPropertyValue(const string& texto, const string& subcadena) {
...
double StudyCase2Host_c::executeAndMeasure_CPU(StudyCase2Kernel& data, EventTimer &event){
    ...
    CPU_ZERO(&cpuset);
    CPU_SET(core, &cpuset);
    function<void()> func = [&data]() { data.kernel_studyCase2_c_CPU(); };
...
double StudyCase2Host_c::executeAndMeasure_CPUopt(StudyCase2Kernel& data, vector<double> &measureByPack, EventTimer &event){
...
void StudyCase2Host_c::threadFunction_DevicePowerMeasure() {
