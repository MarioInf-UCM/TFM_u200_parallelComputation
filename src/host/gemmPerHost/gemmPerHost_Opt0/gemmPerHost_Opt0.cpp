...
atomic<bool> GemmPerHost_Opt0::stop_thread(false);
double GemmPerHost_Opt0::sharedVariable=0.0f;

//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
GemmPerHost_Opt0::GemmPerHost_Opt0(){}
GemmPerHost_Opt0::~GemmPerHost_Opt0(){}
//*************************************
// MAIN FUNCTION - START
//*************************************
...
bool GemmPerHost_Opt0::initParameter(Execution exec, unsigned int &SIZE_I, unsigned int &SIZE_J, unsigned int &SIZE_K){
...
void GemmPerHost_Opt0::emsamble_dataToBuffers(GemmPerKernel& data, vector<typeData> &temp_A, vector<typeData>& temp_B, vector<typeData>& temp_C, vector<typeData>& temp_resultDevice){
...
void GemmPerHost_Opt0::emsamble_buffersToData(GemmPerKernel& data, vector<typeData>& temp_resultDevice){
...
bool GemmPerHost_Opt0::compareResults(GemmPerKernel& data){
...
float GemmPerHost_Opt0::searchPropertyValue(const string& texto, const string& subcadena) {
...
double GemmPerHost_Opt0::executeAndMeasure_CPU(GemmPerKernel& data, EventTimer &event){
...
double GemmPerHost_Opt0::executeAndMeasure_CPUopt(GemmPerKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void GemmPerHost_Opt0::threadFunction_DevicePowerMeasure() {
