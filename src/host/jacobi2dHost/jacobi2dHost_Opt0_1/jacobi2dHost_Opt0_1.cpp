...
#include <vector>
#include <omp.h>
#include "jacobi2dHost_Opt0_1.hpp"
...
//********************************
Jacobi2dHost_Opt0_1::Jacobi2dHost_Opt0_1(){}
Jacobi2dHost_Opt0_1::~Jacobi2dHost_Opt0_1(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool Jacobi2dHost_Opt0_1::exec(Execution exec, vector<double>& results, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"Jacobi2dHost::Jacobi2dHost_Opt0_1_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool Jacobi2dHost_Opt0_1::initParameter(Execution exec, unsigned int &STEPS, unsigned int &SIZE_N){
...
bool Jacobi2dHost_Opt0_1::compareResults(Jacobi_2dKernel& data){
...
void Jacobi2dHost_Opt0_1::ensamble_dataToBuffers(Jacobi_2dKernel& data, vector<typeData> &temp_A, vector<typeData> &temp_B, vector<typeData>& temp_resultDevice){
...
void Jacobi2dHost_Opt0_1::ensamble_buffersToData(Jacobi_2dKernel& data, vector<typeData>& temp_resultDevice){
