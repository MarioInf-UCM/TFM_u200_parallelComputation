...
find_library(LIBXRT_COREUTIL_LIBRARY NAMES xrt_coreutil PATHS ${XRT_POSSIBLE_ROOT_DIRS} PATH_SUFFIXES ${XRT_LIBDIR_SUFFIXES})
...
set(XRT_LIBS ${LIBXRT_CORE_LIBRARY} ${LIBXRT_COREUTIL_LIBRARY} ${LIBXRT_XILOCL_LIBRARY})
