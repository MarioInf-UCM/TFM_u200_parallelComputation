...
def generate_plot(csv_url):
    try:
        ...
        y2 = data['CPU energy consumption']
        y3 = data['CPU optimized energy consumption']
        y4 = data['CPU-1']
        y5 = data['CPU-2']
    ...
    plt.plot(x, y2, marker='o', label='Consumo de la CPU', color='orange')
    plt.plot(x, y3, marker='o', label='Consumo de la CPU optimizada', color='darkorange')
