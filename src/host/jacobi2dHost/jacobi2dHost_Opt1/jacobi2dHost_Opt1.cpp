...
atomic<bool> Jacobi2dHost_Opt1::stop_thread(false);
double Jacobi2dHost_Opt1::sharedVariable=0.0f;
...
// MAIN FUNCTION - START
//*************************************
bool Jacobi2dHost_Opt1::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
void Jacobi2dHost_Opt1::ensamble_dataToBuffers(Jacobi_2dKernel& data, vector<typeData> &temp_A, vector<typeData> &temp_B, vector<typeData>& temp_resultDevice){
...
void Jacobi2dHost_Opt1::ensamble_buffersToData(Jacobi_2dKernel& data, vector<typeData>& temp_resultDevice){
...
float Jacobi2dHost_Opt1::searchPropertyValue(const string& texto, const string& subcadena) {
...
double Jacobi2dHost_Opt1::executeAndMeasure_CPU(Jacobi_2dKernel& data, EventTimer &event){
...
double Jacobi2dHost_Opt1::executeAndMeasure_CPUopt(Jacobi_2dKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void Jacobi2dHost_Opt1::threadFunction_DevicePowerMeasure() {
