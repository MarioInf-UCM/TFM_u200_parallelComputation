#ifndef _CHOLESKYHOST_OPT4_HPP_
#define _CHOLESKYHOST_OPT4_HPP_
...
class CholeskyHost_Opt4 {
    ...
    private:
        ...
        static void emsamble_dataToBuffers(CholeskyKernel& data, typeData_fixed *temp_A, typeData_fixed *temp_resultDevice);
        static void emsamble_buffersToData(CholeskyKernel& data, typeData_fixed *temp_resultDevice);
