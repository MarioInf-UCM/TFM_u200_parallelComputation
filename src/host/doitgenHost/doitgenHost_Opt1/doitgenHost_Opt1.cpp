...
atomic<bool> DoitgenHost_Opt1::stop_thread(false);
double DoitgenHost_Opt1::sharedVariable=0.0f;

//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
DoitgenHost_Opt1::DoitgenHost_Opt1(){}
DoitgenHost_Opt1::~DoitgenHost_Opt1(){}
...
// MAIN FUNCTION - START
//*************************************
bool DoitgenHost_Opt1::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"DoitgenHost::doitgenHost_Opt1_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool DoitgenHost_Opt1::initParameter(Execution exec, unsigned int &SIZE_R, unsigned int &SIZE_Q, unsigned int &SIZE_P){
...
bool DoitgenHost_Opt1::compareResults(DoitgenKernel& data){
...
void DoitgenHost_Opt1::emsamble_dataToBuffers(DoitgenKernel& data, vector<typeData> &temp_A,  vector<typeData>& temp_C4, vector<typeData>& temp_resultDevice){
...
void DoitgenHost_Opt1::emsamble_buffersToData(DoitgenKernel& data, vector<typeData>& temp_resultDevice){
...
float DoitgenHost_Opt1::searchPropertyValue(const string& texto, const string& subcadena) {
...
double DoitgenHost_Opt1::executeAndMeasure_CPU(DoitgenKernel& data, EventTimer &event){
...
double DoitgenHost_Opt1::executeAndMeasure_CPUopt(DoitgenKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void DoitgenHost_Opt1::threadFunction_DevicePowerMeasure() {
