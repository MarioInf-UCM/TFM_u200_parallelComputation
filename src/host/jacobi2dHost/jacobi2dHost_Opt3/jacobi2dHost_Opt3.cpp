...
void Jacobi2dHost_Opt3::ensamble_dataToBuffers(Jacobi_2dKernel& data, vector<typeData> &temp_A, vector<typeData> &temp_B, vector<typeData>& temp_resultDevice){
...
void Jacobi2dHost_Opt3::ensamble_buffersToData(Jacobi_2dKernel& data, vector<typeData>& temp_resultDevice){
