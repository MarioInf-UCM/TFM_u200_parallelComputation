...
// MAIN FUNCTION - START
//*************************************
bool DoitgenHost_Opt1::exec(Execution exec, vector<double>& results, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
void DoitgenHost_Opt1::emsamble_dataToBuffers(DoitgenKernel& data, typeData *temp_A,  typeData *temp_C4, typeData *temp_resultDevice){
...
void DoitgenHost_Opt1::emsamble_buffersToData(DoitgenKernel& data, typeData *temp_resultDevice){
