...
extern "C"{
    ...
    //*************************************
    #ifdef MINI_DATASET
        void ker_jacobi_2d_noOpt_mini(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #elif defined(SMALL_DATASET)
        void ker_jacobi_2d_noOpt_small(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #elif defined(MEDIUM_DATASET)
        void ker_jacobi_2d_noOpt_medium(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #elif defined(LARGE_DATASET)
        void ker_jacobi_2d_noOpt_large(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #elif defined(EXTRALARGE_DATASET)
        void ker_jacobi_2d_noOpt_extralarge(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #else
        void ker_jacobi_2d_noOpt(typeData *inD_A, typeData *inD_B, typeData *outD_result)
    #endif
    {
