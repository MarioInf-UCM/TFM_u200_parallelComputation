...
extern "C"{
    ...
    //*************************************
    #ifdef MINI_DATASET
        void ker_cholesky_Opt3_mini(typeData *inD_A, typeData *outD_A)
    #elif defined(SMALL_DATASET)
        void ker_cholesky_Opt3_small(typeData *inD_A, typeData *outD_A)
    #elif defined(MEDIUM_DATASET)
        void ker_cholesky_Opt3_medium(typeData *inD_A, typeData *outD_A)
    #elif defined(LARGE_DATASET)
        void ker_cholesky_Opt3_large(typeData *inD_A, typeData *outD_A)
    #elif defined(EXTRALARGE_DATASET)
        void ker_cholesky_Opt3_extralarge(typeData *inD_A, typeData *outD_A)
    #else
        void ker_cholesky_Opt3(typeData *inD_A, typeData *outD_A)
    #endif
    {
