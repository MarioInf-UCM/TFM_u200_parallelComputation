...
void Jacobi2dHost_Opt1::ensamble_dataToBuffers(Jacobi_2dKernel& data, vector<typeData> &temp_A, vector<typeData> &temp_B){
...
void Jacobi2dHost_Opt1::ensamble_buffersToData(Jacobi_2dKernel &data, vector<typeData> &temp_A, vector<typeData> &temp_B){
