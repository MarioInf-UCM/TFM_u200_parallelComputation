...
bool StudyCase2Host_d::compareResults(VectorAddKernel& data){
...
void StudyCase2Host_d::ensamble_dataToBuffers(VectorAddKernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_resultDevice){
...
void StudyCase2Host_d::ensamble_buffersToData(VectorAddKernel& data, typeData *temp_resultDevice){
...
double StudyCase2Host_d::executeAndMeasure_CPU(VectorAddKernel& data, EventTimer &event){
...
double StudyCase2Host_d::executeAndMeasure_CPUopt(VectorAddKernel& data, vector<double> &measureByPack, EventTimer &event){
