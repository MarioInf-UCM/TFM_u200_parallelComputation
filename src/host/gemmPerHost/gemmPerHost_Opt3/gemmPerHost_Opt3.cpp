...
atomic<bool> GemmPerHost_Opt3::stop_thread(false);
double GemmPerHost_Opt3::sharedVariable=0.0f;
...
GemmPerHost_Opt3::GemmPerHost_Opt3(){}
GemmPerHost_Opt3::~GemmPerHost_Opt3(){}
//*************************************
// MAIN FUNCTION - START
//*************************************
bool GemmPerHost_Opt3::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"GemmPerHost::gemmPerHost_Opt3_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool GemmPerHost_Opt3::initParameter(Execution exec, unsigned int &SIZE_I, unsigned int &SIZE_J, unsigned int &SIZE_K){
...
void GemmPerHost_Opt3::emsamble_dataToBuffers(GemmPerKernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_C,typeData *temp_resultDevice){
...
void GemmPerHost_Opt3::emsamble_buffersToData(GemmPerKernel& data, typeData *temp_resultDevice){
...
bool GemmPerHost_Opt3::compareResults(GemmPerKernel& data){
...
float GemmPerHost_Opt3::searchPropertyValue(const string& texto, const string& subcadena) {
...
double GemmPerHost_Opt3::executeAndMeasure_CPU(GemmPerKernel& data, EventTimer &event){
...
double GemmPerHost_Opt3::executeAndMeasure_CPUopt(GemmPerKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void GemmPerHost_Opt3::threadFunction_DevicePowerMeasure() {
