...
atomic<bool> StudyCase2Host_a::stop_thread(false);
double StudyCase2Host_a::sharedVariable=0.0f;


//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
StudyCase2Host_a::StudyCase2Host_a(){}
StudyCase2Host_a::~StudyCase2Host_a(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool StudyCase2Host_a::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"VectorAddHost::StudyCase2Host_a_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
// MAIN FUNCTION - END
//*************************************
bool StudyCase2Host_a::initParameter(Execution exec, unsigned int &SIZE){
...
float StudyCase2Host_a::searchPropertyValue(const string& texto, const string& subcadena) {
...
void StudyCase2Host_a::threadFunction_DevicePowerMeasure() {
