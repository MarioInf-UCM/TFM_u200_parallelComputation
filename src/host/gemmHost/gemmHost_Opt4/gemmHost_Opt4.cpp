...
atomic<bool> GemmHost_Opt4::stop_thread(false);
double GemmHost_Opt4::sharedVariable=0.0f;
...
GemmHost_Opt4::GemmHost_Opt4(){}
GemmHost_Opt4::~GemmHost_Opt4(){}
//*************************************
// MAIN FUNCTION - START
//*************************************
bool GemmHost_Opt4::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"GemmHost::gemmHost_Opt4_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool GemmHost_Opt4::initParameter(Execution exec, unsigned int &SIZE_I, unsigned int &SIZE_J, unsigned int &SIZE_K){
...
void GemmHost_Opt4::emsamble_dataToBuffers(GemmKernel& data, typeData_fixed *temp_A, typeData_fixed *temp_B, typeData_fixed *temp_C, typeData_fixed *temp_resultDevice){
...
void GemmHost_Opt4::emsamble_buffersToData(GemmKernel& data, typeData_fixed *temp_resultDevice){
...
bool GemmHost_Opt4::compareResults(GemmKernel& data){
...
float GemmHost_Opt4::searchPropertyValue(const string& texto, const string& subcadena) {
...
double GemmHost_Opt4::executeAndMeasure_CPU(GemmKernel& data, EventTimer &event){
    ...
    CPU_ZERO(&cpuset);
    CPU_SET(core, &cpuset);
    function<void()> func = [&data]() { data.kernel_gemm_CPU(); };
...
double GemmHost_Opt4::executeAndMeasure_CPUopt(GemmKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void GemmHost_Opt4::threadFunction_DevicePowerMeasure() {
