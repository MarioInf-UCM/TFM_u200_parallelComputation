...
atomic<bool> CholeskyHost_Opt2::stop_thread(false);
double CholeskyHost_Opt2::sharedVariable=0.0f;
...
//********************************
CholeskyHost_Opt2::CholeskyHost_Opt2(){}
CholeskyHost_Opt2::~CholeskyHost_Opt2(){}
...
// MAIN FUNCTION - START
//*************************************
bool CholeskyHost_Opt2::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
bool CholeskyHost_Opt2::initParameter(Execution exec, unsigned int &SIZE_N){
...
bool CholeskyHost_Opt2::compareResults(CholeskyKernel& data){
...
void CholeskyHost_Opt2::emsamble_dataToBuffers(CholeskyKernel& data, typeData *temp_A, typeData *temp_resultDevice){
    int i=0;
    for (int n1 = 0; n1 < data.get_SIZE_N(); n1++) {
        for (int n2 = 0; n2 < data.get_SIZE_N(); n2++) {
...
void CholeskyHost_Opt2::emsamble_buffersToData(CholeskyKernel& data, typeData *temp_resultDevice){
...
float CholeskyHost_Opt2::searchPropertyValue(const string& texto, const string& subcadena) {
...
double CholeskyHost_Opt2::executeAndMeasure_CPU(CholeskyKernel& data, EventTimer &event){
...
double CholeskyHost_Opt2::executeAndMeasure_CPUopt(CholeskyKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void CholeskyHost_Opt2::threadFunction_DevicePowerMeasure() {
