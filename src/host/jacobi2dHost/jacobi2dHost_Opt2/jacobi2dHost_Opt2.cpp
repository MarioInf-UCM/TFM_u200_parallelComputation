...
atomic<bool> Jacobi2dHost_Opt2::stop_thread(false);
double Jacobi2dHost_Opt2::sharedVariable=0.0f;
...
// MAIN FUNCTION - START
//*************************************
bool Jacobi2dHost_Opt2::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
float Jacobi2dHost_Opt2::searchPropertyValue(const string& texto, const string& subcadena) {
...
double Jacobi2dHost_Opt2::executeAndMeasure_CPU(Jacobi_2dKernel& data, EventTimer &event){
...
double Jacobi2dHost_Opt2::executeAndMeasure_CPUopt(Jacobi_2dKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void Jacobi2dHost_Opt2::threadFunction_DevicePowerMeasure() {
