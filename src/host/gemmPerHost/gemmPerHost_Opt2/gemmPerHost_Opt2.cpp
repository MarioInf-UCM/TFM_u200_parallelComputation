...
atomic<bool> GemmPerHost_Opt2::stop_thread(false);
double GemmPerHost_Opt2::sharedVariable=0.0f;
...
GemmPerHost_Opt2::GemmPerHost_Opt2(){}
GemmPerHost_Opt2::~GemmPerHost_Opt2(){}
//*************************************
// MAIN FUNCTION - START
//*************************************
bool GemmPerHost_Opt2::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"GemmPerHost::gemmPerHost_Opt2_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool GemmPerHost_Opt2::initParameter(Execution exec, unsigned int &SIZE_I, unsigned int &SIZE_J, unsigned int &SIZE_K){
...
void GemmPerHost_Opt2::emsamble_dataToBuffers(GemmPerKernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_C,typeData *temp_resultDevice){
...
void GemmPerHost_Opt2::emsamble_buffersToData(GemmPerKernel& data, typeData *temp_resultDevice){
...
bool GemmPerHost_Opt2::compareResults(GemmPerKernel& data){
...
float GemmPerHost_Opt2::searchPropertyValue(const string& texto, const string& subcadena) {
...
double GemmPerHost_Opt2::executeAndMeasure_CPU(GemmPerKernel& data, EventTimer &event){
...
double GemmPerHost_Opt2::executeAndMeasure_CPUopt(GemmPerKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void GemmPerHost_Opt2::threadFunction_DevicePowerMeasure() {
