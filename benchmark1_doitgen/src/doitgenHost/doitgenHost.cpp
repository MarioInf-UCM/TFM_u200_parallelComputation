...
bool DoitgenHost::doitgenHost_exec(Execution exec, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    ...
    if(exec.get_kernelPackage().find("noOpt") != string::npos){
        ...
        result = DoitgenHost_noOpt::doitgenHost_noOpt_exec(exec, fileWriter_logFile, fileWriter_statsFile);
