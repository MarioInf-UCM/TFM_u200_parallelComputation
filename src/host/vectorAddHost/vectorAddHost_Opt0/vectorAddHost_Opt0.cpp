...
atomic<bool> VectorAddHost_Opt0::stop_thread(false);
double VectorAddHost_Opt0::sharedVariable=0.0f;
...
// MAIN FUNCTION - START
//*************************************
bool VectorAddHost_Opt0::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
float VectorAddHost_Opt0::searchPropertyValue(const string& texto, const string& subcadena) {
...
double VectorAddHost_Opt0::executeAndMeasure_CPU(VectorAddKernel& data, EventTimer &event){
...
double VectorAddHost_Opt0::executeAndMeasure_CPUopt(VectorAddKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void VectorAddHost_Opt0::threadFunction_DevicePowerMeasure() {
