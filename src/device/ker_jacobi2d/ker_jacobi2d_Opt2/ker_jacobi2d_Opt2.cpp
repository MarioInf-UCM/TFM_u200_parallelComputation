...
extern "C"{
    ...
    //*************************************
    #ifdef MINI_DATASET
        void ker_jacobi2d_Opt2_mini(typeData *inD_A, typeData *inD_B)
    #elif defined(SMALL_DATASET)
        void ker_jacobi2d_Opt2_small(typeData *inD_A, typeData *inD_B)
    #elif defined(MEDIUM_DATASET)
        void ker_jacobi2d_Opt2_medium(typeData *inD_A, typeData *inD_B)
    #elif defined(LARGE_DATASET)
        void ker_jacobi2d_Opt2_large(typeData *inD_A, typeData *inD_B)
    #elif defined(EXTRALARGE_DATASET)
        void ker_jacobi2d_Opt2_extralarge(typeData *inD_A, typeData *inD_B)
    #else
        void ker_jacobi2d_Opt2(typeData *inD_A, typeData *inD_B)
    #endif
    {
