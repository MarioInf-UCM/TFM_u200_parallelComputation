...
//********************************
GemmHost_Opt0_1::GemmHost_Opt0_1(){}
GemmHost_Opt0_1::~GemmHost_Opt0_1(){}
//*************************************
// MAIN FUNCTION - START
//*************************************
bool GemmHost_Opt0_1::exec(Execution exec, vector<double>& results, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"GemmHost::gemmHost_Opt0_1_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool GemmHost_Opt0_1::initParameter(Execution exec, unsigned int &SIZE_I, unsigned int &SIZE_J, unsigned int &SIZE_K){
...
bool GemmHost_Opt0_1::compareResults(GemmKernel& data){
...
void GemmHost_Opt0_1::emsamble_dataToBuffers(GemmKernel& data, vector<typeData> &temp_A, vector<typeData>& temp_B, vector<typeData>& temp_C, vector<typeData>& temp_resultDevice){
...
void GemmHost_Opt0_1::emsamble_buffersToData(GemmKernel& data, vector<typeData>& temp_resultDevice){
