...
#include "vectorAddHost_Opt3.hpp"
...
atomic<bool> VectorAddHost_Opt3::stop_thread(false);
double VectorAddHost_Opt3::sharedVariable=0.0f;


//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
VectorAddHost_Opt3::VectorAddHost_Opt3(){}
VectorAddHost_Opt3::~VectorAddHost_Opt3(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool VectorAddHost_Opt3::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"VectorAddHost::VectorAddHost_Opt3_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
// MAIN FUNCTION - END
//*************************************
bool VectorAddHost_Opt3::initParameter(Execution exec, unsigned int &SIZE){
...
bool VectorAddHost_Opt3::compareResults(VectorAddKernel& data){
...
void VectorAddHost_Opt3::ensamble_dataToBuffers(VectorAddKernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_resultDevice){
...
void VectorAddHost_Opt3::ensamble_buffersToData(VectorAddKernel& data, typeData *temp_resultDevice){
...
float VectorAddHost_Opt3::searchPropertyValue(const string& texto, const string& subcadena) {
...
double VectorAddHost_Opt3::executeAndMeasure_CPU(VectorAddKernel& data, EventTimer &event){
...
double VectorAddHost_Opt3::executeAndMeasure_CPUopt(VectorAddKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void VectorAddHost_Opt3::threadFunction_DevicePowerMeasure() {
