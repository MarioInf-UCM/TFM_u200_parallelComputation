#ifndef _GEMMHOST_OPT4_HPP_
#define _GEMMHOST_OPT4_HPP_
...
class GemmHost_Opt4 {
    ...
    private:
        ...
        static void emsamble_dataToBuffers(GemmKernel& data, typeData_fixed *temp_A, typeData_fixed *temp_B, typeData_fixed *temp_C,typeData_fixed *temp_resultDevice);
        static void emsamble_buffersToData(GemmKernel& data, typeData_fixed *temp_resultDevice);
