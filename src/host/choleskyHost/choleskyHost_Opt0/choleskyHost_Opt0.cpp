...
atomic<bool> CholeskyHost_Opt0::stop_thread(false);
double CholeskyHost_Opt0::sharedVariable=0.0f;
...
// MAIN FUNCTION - START
//*************************************
bool CholeskyHost_Opt0::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
...
float CholeskyHost_Opt0::searchPropertyValue(const string& texto, const string& subcadena) {
...
double CholeskyHost_Opt0::executeAndMeasure_CPU(CholeskyKernel& data, EventTimer &event){
...
double CholeskyHost_Opt0::executeAndMeasure_CPUopt(CholeskyKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void CholeskyHost_Opt0::threadFunction_DevicePowerMeasure() {
