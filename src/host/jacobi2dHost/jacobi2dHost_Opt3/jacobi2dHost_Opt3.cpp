...
atomic<bool> Jacobi2dHost_Opt3::stop_thread(false);
double Jacobi2dHost_Opt3::sharedVariable=0.0f;


//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
Jacobi2dHost_Opt3::Jacobi2dHost_Opt3(){}
Jacobi2dHost_Opt3::~Jacobi2dHost_Opt3(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool Jacobi2dHost_Opt3::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"Jacobi2dHost::Jacobi2dHost_Opt3_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool Jacobi2dHost_Opt3::initParameter(Execution exec, unsigned int &STEPS, unsigned int &SIZE_N){
...
bool Jacobi2dHost_Opt3::compareResults(Jacobi_2dKernel& data){
...
void Jacobi2dHost_Opt3::ensamble_dataToBuffers(Jacobi_2dKernel& data, typeData *temp_A, typeData *temp_B){
...
void Jacobi2dHost_Opt3::ensamble_buffersToData(Jacobi_2dKernel& data, typeData *temp_A, typeData *temp_B){
...
float Jacobi2dHost_Opt3::searchPropertyValue(const string& texto, const string& subcadena) {
...
double Jacobi2dHost_Opt3::executeAndMeasure_CPU(Jacobi_2dKernel& data, EventTimer &event){
...
double Jacobi2dHost_Opt3::executeAndMeasure_CPUopt(Jacobi_2dKernel& data, vector<double> &measureByPack, EventTimer &event){
...
void Jacobi2dHost_Opt3::threadFunction_DevicePowerMeasure() {
