...
atomic<bool> StudyCase2Host_b::stop_thread(false);
double StudyCase2Host_b::sharedVariable=0.0f;


//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
StudyCase2Host_b::StudyCase2Host_b(){}
StudyCase2Host_b::~StudyCase2Host_b(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool StudyCase2Host_b::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"VectorAddHost::StudyCase2Host_b_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
    ...
    if(exec.get_measurePower_CPUopt()){
        ...
        data.kernel_studyCase2_b_CPU_opt();
    }
...
// MAIN FUNCTION - END
//*************************************
bool StudyCase2Host_b::initParameter(Execution exec, unsigned int &SIZE){
...
bool StudyCase2Host_b::compareResults(StudyCase2Kernel& data){
...
void StudyCase2Host_b::ensamble_dataToBuffers(StudyCase2Kernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_resultDevice){
...
void StudyCase2Host_b::ensamble_buffersToData(StudyCase2Kernel& data, typeData *temp_resultDevice){
...
float StudyCase2Host_b::searchPropertyValue(const string& texto, const string& subcadena) {
...
double StudyCase2Host_b::executeAndMeasure_CPU(StudyCase2Kernel& data, EventTimer &event){
    ...
    CPU_ZERO(&cpuset);
    CPU_SET(core, &cpuset);
    function<void()> func = [&data]() { data.kernel_studyCase2_b_CPU(); };
...
double StudyCase2Host_b::executeAndMeasure_CPUopt(StudyCase2Kernel& data, vector<double> &measureByPack, EventTimer &event){
...
void StudyCase2Host_b::threadFunction_DevicePowerMeasure() {
