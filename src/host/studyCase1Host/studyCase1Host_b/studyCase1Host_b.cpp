...
atomic<bool> StudyCase1Host_b::stop_thread(false);
double StudyCase1Host_b::sharedVariable=0.0f;


//********************************
//* CONSTRUCTORS AND DESTRUCTORS *
//********************************
StudyCase1Host_b::StudyCase1Host_b(){}
StudyCase1Host_b::~StudyCase1Host_b(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool StudyCase1Host_b::exec(Execution exec, vector<double>& resultsPerformance, vector<double>& resultsPower, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"VectorAddHost::StudyCase1Host_b_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
    ...
    if(exec.get_measurePower_CPUopt()){
        ...
        data.kernel_studyCase1_b_CPU_opt();
    }
...
// MAIN FUNCTION - END
//*************************************
bool StudyCase1Host_b::initParameter(Execution exec, unsigned int &SIZE){
...
bool StudyCase1Host_b::compareResults(StudyCase1Kernel& data){
...
void StudyCase1Host_b::ensamble_dataToBuffers(StudyCase1Kernel& data, vector<typeData> &temp_A, vector<typeData> &temp_B, vector<typeData>& temp_resultDevice){
...
void StudyCase1Host_b::ensamble_buffersToData(StudyCase1Kernel& data, vector<typeData>& temp_resultDevice){
...
float StudyCase1Host_b::searchPropertyValue(const string& texto, const string& subcadena) {
...
double StudyCase1Host_b::executeAndMeasure_CPU(StudyCase1Kernel& data, EventTimer &event){
    ...
    CPU_ZERO(&cpuset);
    CPU_SET(core, &cpuset);
    function<void()> func = [&data]() { data.kernel_studyCase1_b_CPU(); };
...
double StudyCase1Host_b::executeAndMeasure_CPUopt(StudyCase1Kernel& data, vector<double> &measureByPack, EventTimer &event){
...
void StudyCase1Host_b::threadFunction_DevicePowerMeasure() {
