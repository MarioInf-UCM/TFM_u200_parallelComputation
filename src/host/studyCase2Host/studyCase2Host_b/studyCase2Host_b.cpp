...
bool StudyCase2Host_b::compareResults(VectorAddKernel& data){
...
void StudyCase2Host_b::ensamble_dataToBuffers(VectorAddKernel& data, typeData *temp_A, typeData *temp_B, typeData *temp_resultDevice){
...
void StudyCase2Host_b::ensamble_buffersToData(VectorAddKernel& data, typeData *temp_resultDevice){
...
double StudyCase2Host_b::executeAndMeasure_CPU(VectorAddKernel& data, EventTimer &event){
...
double StudyCase2Host_b::executeAndMeasure_CPUopt(VectorAddKernel& data, vector<double> &measureByPack, EventTimer &event){
