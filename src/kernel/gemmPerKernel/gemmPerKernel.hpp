#ifndef _GEMMPERKERNEL_HPP_
#define _GEMMPERKERNEL_HPP_
...
class GemmPerKernel{
    ...
    public:
        ...
        //********************************
        GemmPerKernel(typeData alpha, typeData beta, unsigned int SIZE_I, unsigned int SIZE_J, unsigned int SIZE_K);
        ~GemmPerKernel();
        ...
        void kernel_gemmPer_CPU();
        void kernel_gemmPer_CPU_opt();
