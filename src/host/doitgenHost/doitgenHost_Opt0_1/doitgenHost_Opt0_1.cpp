...
#include <vector>
#include <omp.h>
#include "doitgenHost_Opt0_1.hpp"
...
//********************************
DoitgenHost_Opt0_1::DoitgenHost_Opt0_1(){}
DoitgenHost_Opt0_1::~DoitgenHost_Opt0_1(){}

//*************************************
// MAIN FUNCTION - START
//*************************************
bool DoitgenHost_Opt0_1::exec(Execution exec, vector<double>& results, FileWriter_service fileWriter_logFile, FileWriter_service fileWriter_statsFile){
    fileWriter_logFile.writeln("Executing host function \"DoitgenHost::doitgenHost_Opt0_1_exec\". Execution configuration:\n" + exec.displayInfo("\t"));
...
bool DoitgenHost_Opt0_1::initParameter(Execution exec, unsigned int &SIZE_R, unsigned int &SIZE_Q, unsigned int &SIZE_P){
...
bool DoitgenHost_Opt0_1::compareResults(DoitgenKernel& data){
...
void DoitgenHost_Opt0_1::emsamble_dataToBuffers(DoitgenKernel& data, vector<typeData> &temp_A,  vector<typeData>& temp_C4, vector<typeData>& temp_resultDevice){
...
void DoitgenHost_Opt0_1::emsamble_buffersToData(DoitgenKernel& data, vector<typeData>& temp_resultDevice){
